<template>
  <div class="services">
    <div class="load" v-if="loadSections">loading</div>
    <div v-else>
      <h2>{{ serviceByType.title2 }}</h2>
      <p class="description">{{ serviceByType.text }}</p>
      <div class="block-menu">
        <leftMenu
          :options="sectionsByType"
          @clickBlock="clickBlock"
          :activeBlock="activeServiceBlock"
        />
        <div class="right">
          <div class="load" v-if="loadServices">load</div>
          <div
            v-else
            ...
            class="block"
            :class="{
              once: services(activeServiceBlock).length === 1 && service.text,
              hover: service.text && services(activeServiceBlock).length > 1,
            }"
          >
            ...
            <div class="title">
              ...
              <img
                v-if="service.text && services(activeServiceBlock).length > 1"
            ...
            <transition name="text">
              <p
                v-if="
                  ...
                  services(activeServiceBlock).length === 1
                "
                class="info"
              >
                {{ service.text }}
...
export default {
  ...
  data: () => ({
    ...
    backEndServices: {
      1: [
        {
          title:
            "Правовое заключение об отсутствии необходимости лицензирования",
        },
        { title: "Лицензия на осуществление образовательной деятельности" },
        {
          title:
            "Лицензия на алкоголь (на деятельность в области производства и оборота этилового спирта, алкогольной и спиртосодержащей продукции)",
        },
        {
          title:
        ...
        {
          title:
            "Лицензия на осуществление предпринимательской деятельности по управлению многоквартирными домами города Москвы",
        },
        {
          title:
            "Лицензия на осуществление деятельности в области оказания услуг связи",
        },
        {
          title:
            "Лицензирование деятельности по продаже ювелирных изделий, драгоценных металлов и камней",
        },
      ],
      2: [
        {
          title:
            "Консультирование по всем вопросам гражданского, трудового, жилищного, корпоративного, земельного и др. области права",
        },
        {
          title:
            "Консультирование по вопросам защиты интересов клиента в судах РФ",
        },
      ],
      3: [
        {
          title:
            "Юридический анализ документов (договоров, ходатайств, запросов, приказов и т.д.) и предоставление письменных заключений",
        },
        { title: "Экспертиза внутренней документации юридического лица" },
        { title: "Разработка локальных правовых документов компании" },
        {
          title:
            "Разработка договоров и иных документов, сопровождающих деятельность компании",
        },
      ],
      4: [
        ...
        {
          title:
            "Представление интересов юридического лица в государственных и муниципальных органах",
        },
        ...
        {
          title:
            "Представление интересов юридического лица при проверках государственных и муниципальных органов",
        },
        {
          title:
            "Представление интересов юридического лица в рамках административного производства на всех стадиях",
        },
      ],
      5: [
        {
      ...
      7: [{ title: "Услуги адвоката" }],
      8: [
        {
          title:
            "Экспертиза Ваших учредительных документов и локальных актов, регулирующих деятельность клиента (устав, учредительный договор, положения о структурных подразделениях, правила внутреннего трудового распорядка, должностные инструкции)",
        },
        {
          title:
            "Выработка рекомендаций по изменению и дополнению Ваших учредительных документов и локальных актов с целью приведения их в соответствие с требованиями законодательства и Вашими интересами",
        },
        {
          title:
            "Экспертиза гражданско-правовых договоров, заключенных Вами, и совершенных Вами юридических действий",
        },
      ],
      9: [
        {
    ...
    backEndTitles: {
      legal: {
        ...
        description:
          "Юридическое бюро «Совет» настоятельно рекомендует своевременно обращаться к специалистам, основная задача которых состоит в обеспечении юридической безопасности бизнеса",
      },
      individuals: {
        title: "Услуги для физических лиц",
        description:
          "Юридическое бюро «Совет» настоятельно рекомендует своевременно обращаться к специалистам, основная задача которых состоит в обеспечении юридической безопасности частных лиц",
      },
      expertise: {
        title: "Независимая правовая экспертиза",
        description:
          "Центр независимой правовой экспертизы на базе АНО Юридическое бюро «Совет» создан в целях обеспечения максимальное эффективности работы по проведению экспертиз, таким образом, гарантирую качество и результативность экспертиз",
      },
    },
    loadSections: false,
    loadServices: false,
  ...
  methods: {
    ...
    fetchSections() {
      ...
      let sections = [];
      this.$store.dispatch("services/setSections", {
