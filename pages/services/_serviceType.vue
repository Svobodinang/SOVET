    ...
    <div v-else>
      ...
      <div class="content">
        <div class="left">
          <ul class="menu">
            <li
              v-for="(service) in sectionsByType"
              class="big-text"
              :class="{'active': activeServiceBlock === service.id}"
              :key="service.id"
              @click="activeServiceBlock = service.id; activeServiceTitle = null"
            >
            {{service.title}}
            </li>
          </ul>
        ...
        <div class="right">
          ...
          <div
            ...
            class="block"
            :class="{'once': services(activeServiceBlock).length === 1 && service.text, 'hover': service.text}"
          >
